...
import com.zim.demo.instrument.agent.AgentMain;
import java.io.File;
...
public class Instruments {
	...
	public static void start(InstrumentTask task) {
	...
	private static Instrumentation instrumentation() {
		...
		try {
			final Class<?> javaAgentClass = mainAppLoader
					.loadClass(AgentMain.class.getCanonicalName());
	...
	private static VirtualMachine getVirtualMachineImplementationFromEmbeddedOnes() {
		...
		try {
			...
			Constructor<? extends VirtualMachine> vmConstructor = vmClass
