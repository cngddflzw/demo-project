 ...
 * VirtualMachineDescriptor VirtualMachineDescriptor} obtained
 ...
 * {@link System#getProperties() system properties} in the target VM.
...
public abstract class VirtualMachine {
     ...
     * VirtualMachineDescriptor} elements.
     ...
     * {@link AttachProvider attach providers}.
     ...
     * {@link AttachNotSupportedException AttachNotSupportedException}
     ...
     * AttachProvider#attachVirtualMachine(VirtualMachineDescriptor)
     ...
     * operations on that virtual machine will cause an {@link IOException
     ...
     *
     * <p> If the <code>Agent_OnAttach</code> function in the agent library returns
     * an error then an {@link AgentInitializationException} is
     * thrown. The return value from the <code>Agent_OnAttach</code> can then be
     * obtained by invoking the {@link
     * com.sun.tools.attach.AgentInitializationException#returnValue() returnValue}
     * method on the exception. </p>
     ...
     * method {@link System#getProperties System.getProperties}
